...
/* ========================================================================
 * Time since directive used in grad widgets
 * ========================================================================
 */

appDirectives.directive('timeSinceDir', ['$interval', 'dateFilter', 'timeSinceFilter', function($interval, dateFilter, timeSinceFilter) {
  ...
  function link(scope, element, attrs) {
    ...
    function updateTime() {
      element.text(timeSinceFilter(scope.gms.status.lastQuestionAns));
    }
