...
appDirectives.directive('bootstrapCalendar', ['scriptLoader',function(scriptLoader){
    return {
        ...
        link: function(scope, $el, attrs){
            ...
            scriptLoader.loadScripts([
                'vendor/bootstrap-calendar/bootstrap_calendar/js/bootstrap_calendar.min.js'
            ])
                .then(function(){
...
appDirectives.directive('jqSparkline', ['scriptLoader', function (scriptLoader) {
    return {
        ...
        link: function (scope, $el, attrs, ngModel) {
            ...
            scriptLoader.loadScripts(['vendor/jquery.sparkline/dist/jquery.sparkline.js'])
                .then(function(){
...
appDirectives.directive('dropzone', ['scriptLoader', function (scriptLoader) {
    return function (scope, element, attrs) {
        ...
        scriptLoader.loadScripts(['vendor/dropzone/downloads/dropzone.min.js'])
            .then(render)
    };
}]);